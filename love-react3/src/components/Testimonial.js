...
const Testimonial = ({ reviews }) => {
    const[index,setIndex] = useState(0);
      ...
      function leftShiftHandler(){
        // index se 1  minus karbe par if negative aaye to last elem show
    ...
    return (
        <div className='w-[80vw] md:w-[700px] bg-white flex flex-col justify-center items-center mt-10 p-10 transition-all duration-700 hover:shadow-xl rounded-md h-[60vh]'>
