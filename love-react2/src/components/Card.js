...
const Card = ({ course,likedCourses,setLikedCourses}) => {
  ...
  function clickHandler(){
    ...
    if(likedCourses.includes(course.id)){
      setLikedCourses((prev)=>prev.filter((cid)=>(cid!==course.id))) // doing unlike
  ...
  return (
    <div className='bg-black bg-opacity-80 w-[300px] rounded overflow-hidden'>
